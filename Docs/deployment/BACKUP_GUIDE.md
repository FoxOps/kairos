...
### For local backup
- Python 3.11+ (matches `docker/Dockerfile`/`.github/workflows/tests.yml`; the codebase uses PEP 604 `X | None` type hints, which require at least Python 3.10)
