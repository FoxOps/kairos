...
> **Version** : 5.13.0 - API REST publique (flask-smorest, comptes de service)
> **Version app** : 0.9.3 (`/version`) - Hérite de la sécurité sidebar/workflow d'échange en 2 temps (v0.9.2), des notifications externes via Apprise (v0.9.1), de l'audit trail
