...
admin_automation_routes, admin_backup_routes) which all register onto
the admin_bp defined here - the blueprint name stays "admin" everywhere
(url_for("admin.xxx"), templates), only the file split changes.
"""
