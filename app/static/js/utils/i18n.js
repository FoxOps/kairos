 ...
 * #i18n-strings JSON script tag) - the CDN-only/no-build-step
 * constraint (see CLAUDE.md's Frontend section) means there's no
 * i18next-style pipeline available, so translation happens server-side
