...
def get_int_from_env(env_var, default=0):
    ...
    try:
        ...
        logging.warning(
            f"Valeur non entière pour {env_var}: '{value}'. Utilisation de la valeur par défaut: {default}"
        )
        return default
...
def get_json_from_env(env_var, default=None):
    ...
    try:
        ...
        logging.warning(
            f"Valeur JSON invalide pour {env_var}: '{value}'. Utilisation de la valeur par défaut"
        )
        return default
