...
def get_engine():
    # This project pins Flask-SQLAlchemy>=3 (see requirements.txt), which
    # exposes the engine directly - no need for the older get_engine()
    # fallback (deprecated, and calling it still emits its own warning
