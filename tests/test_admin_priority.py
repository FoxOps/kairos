...
class TestEditGroup:
    ...
    def test_edit_group_get(self, logged_in_admin_client, test_group):
        """Test l'affichage du formulaire d'édition de groupe."""
        response = logged_in_admin_client.get(f"/admin/groups/edit/{test_group.id}")
        assert response.status_code == 200

    def test_edit_group_post_update_name(self, logged_in_admin_client, test_group):
...
class TestEditUser:
    ...
    def test_edit_user_get(self, logged_in_admin_client, test_user):
        """Test l'affichage du formulaire d'édition d'utilisateur."""
        response = logged_in_admin_client.get(f"/admin/users/edit/{test_user.id}")
        assert response.status_code == 200

    def test_edit_user_post_update(self, logged_in_admin_client, test_user):
...
class TestEditShiftType:
    ...
    def test_edit_shift_type_get(self, logged_in_admin_client, test_shift_type):
        """Test l'affichage du formulaire d'édition de type de shift."""
        response = logged_in_admin_client.get(f"/admin/shift-types/edit/{test_shift_type.id}")
        assert response.status_code == 200

    def test_edit_shift_type_post_update(self, logged_in_admin_client, test_shift_type):
...
class TestDeleteGroup:
    ...
    def test_delete_group_without_users(self, logged_in_admin_client, group_not_in_schedule):
...
class TestDeleteUser:
    ...
    def test_delete_user_without_resources(self, logged_in_admin_client, second_user):
    ...
    def test_delete_user_with_shifts(self, logged_in_admin_client, test_user, test_shift_type):
...
class TestDeleteShiftType:
    ...
    def test_delete_shift_type_unused(self, logged_in_admin_client, afternoon_shift_type):
    ...
    def test_delete_shift_type_in_use(self, logged_in_admin_client, test_shift_type, test_user):
