...
from app.utils.ics_exporter import generate_ics_shifts, generate_ics_oncall, generate_ics_leaves, generate_ics_standard
...
class TestICSExport:
    ...
    def test_generate_ics_multiple_oncalls(self, app, test_user):
        ...
        with app.app_context():
            ...
            for i in range(2):
                ...
                start_time = datetime.combine(friday_date, datetime.min.time()).replace(hour=21)
    ...
    def test_generate_ics_standard_with_mixed_events(self, app, test_user, test_shift_type):
