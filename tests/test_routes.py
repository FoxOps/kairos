...
class TestAuthRoutes:
    ...
    def test_register_disabled(self, client):
        ...
        assert b'Login' in response.data or b'Connexion' in response.data or b'email' in response.data
    ...
    def test_profile_update_post_invalid_email(self, logged_in_client, test_user, second_user, app):
        ...
        assert b'email' in response.data.lower() or b'Profil' in response.data or b'profile' in response.data.lower()
...
class TestShiftRoutes:
    ...
    def test_add_shift_post_invalid_dates_weekend(self, logged_in_admin_client, test_user, test_shift_type):
        ...
        assert b'Shifts' in response.data or b'schedule' in response.data.lower() or b'Add' in response.data
...
class TestOnCallRoutes:
    ...
    def test_add_oncall_get_admin(self, logged_in_admin_client):
        ...
        assert response.status_code == 200
        assert b'Ajouter une astreinte' in response.data or b'Add OnCall' in response.data
...
class TestLeaveRoutes:
    ...
    def test_add_leave_get(self, logged_in_client):
        ...
        assert response.status_code == 200
        assert b'Ajouter' in response.data and (b'Conge' in response.data or b'leave' in response.data.lower())
    ...
    def test_add_leave_post_invalid_dates(self, logged_in_client, test_user):
        ...
        assert response.status_code == 200
        # Le formulaire est reaffiche avec un message d'erreur
        assert b'date' in response.data.lower() or b'debut' in response.data.lower() or b'fin' in response.data.lower()
...
class TestAdminRoutes:
    ...
    def test_list_groups(self, logged_in_admin_client):
        ...
        assert response.status_code == 200
        assert b'Gestion des groupes' in response.data or b'groups' in response.data.lower()
    ...
    def test_delete_group_post(self, logged_in_admin_client, test_group):
        ...
        assert b'Groupe' in response.data or b'groups' in response.data.lower() or b'succes' in response.data
    ...
    def test_delete_group_with_users(self, logged_in_admin_client, test_group, test_user):
        ...
        assert b'Groupe' in response.data or b'groups' in response.data.lower() or b'Impossible' in response.data
    ...
    def test_list_users(self, logged_in_admin_client):
        ...
        assert response.status_code == 200
        assert b'Gestion des utilisateurs' in response.data or b'users' in response.data.lower()
...
class TestShiftTypeRoutes:
    ...
    def test_add_shift_type_post_valid(self, logged_in_admin_client):
        ...
        response = logged_in_admin_client.post('/admin/shift-types/add', data=data, follow_redirects=True)
        assert response.status_code == 200
        # Vérifier que le type a ete ajoute ou qu'un message est affiche
        assert b'Type' in response.data or b'shift' in response.data.lower() or b'succes' in response.data
    ...
    def test_add_shift_type_post_invalid_hours(self, logged_in_admin_client):
        ...
        assert response.status_code == 200
        # Le formulaire est reaffiche avec un message d'erreur
        assert b'Type' in response.data or b'shift' in response.data.lower() or b'Add' in response.data
