...
def test_shift_rotation_first_day_of_oncall(app_context):
    ...
    with app_context.app_context():
        ...
        assert shift == AdvancedShiftAutomation.SHIFT_09_17, (
        ...
        assert shift == AdvancedShiftAutomation.SHIFT_13_21, (
...
def test_shift_rotation_after_previous_oncall(app_context):
    ...
    with app_context.app_context():
        ...
        previous_oncall = OnCall(user_id=user.id, start_time=start_time, end_time=end_time)
        ...
        assert shift == AdvancedShiftAutomation.SHIFT_07_15, (
