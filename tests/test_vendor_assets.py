...
class TestFontAwesome:
    ...
    def test_font_awesome_css_exists(self, test_app):
    ...
    def test_font_awesome_css_version(self, test_app):
    ...
    def test_font_awesome_webfonts_referenced_in_css(self, test_app):
...
class TestBulma:
    ...
    def test_bulma_css_exists(self, test_app):
...
class TestFullCalendar:
    ...
    def test_fullcalendar_js_exists(self, test_app):
    ...
    def test_fullcalendar_locale_fr_exists(self, test_app):
