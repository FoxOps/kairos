...
class TestShiftAutomationGenerateScheduleFull:
    ...
    def test_generates_shifts_for_week(
        self, test_app, test_user, test_group, test_shift_type
    ):
        ...
        with test_app.app_context():
            ...
            shifts, messages = ShiftAutomation.generate_shift_schedule(
                start_date, end_date, rules=rules, dry_run=True
            )
    ...
    def test_handles_missing_shift_type(self, test_app, test_user, test_group):
        ...
        with test_app.app_context():
            ...
            assert len(shifts) == 0 or any(
                "trouvé" in msg or "found" in msg for msg in messages
            )
    ...
    def test_false_existing_shift(self, test_app, test_user, test_shift_type):
        ...
        with test_app.app_context():
            ...
            today = date.today() + timedelta(
                days=(7 - weekday) % 7 if weekday >= 5 else 0
            )
